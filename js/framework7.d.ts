...
import request from 'framework7/shared/request';
import { getSupport } from 'framework7/shared/get-support';
import { getDevice } from 'framework7/shared/get-device';
import { Utils } from 'framework7/shared/utils';

import { Clicks as ClicksModule } from 'framework7/modules/clicks/clicks';
import { Component as ComponentModule } from 'framework7/modules/component/component';
import { Device as DeviceModule } from 'framework7/modules/device/device';
import { Request as RequestModule } from 'framework7/modules/request/request';
import { Resize as ResizeModule } from 'framework7/modules/resize/resize';
import { Router as RouterModule } from 'framework7/modules/router/router';
import { ServiceWorker as ServiceWorkerModule } from 'framework7/modules/service-worker/service-worker';
import { Store as StoreModule } from 'framework7/modules/store/store';
import { Support as SupportModule } from 'framework7/modules/support/support';
import { Touch as TouchModule } from 'framework7/modules/touch/touch';
import { Utils as UtilsModule } from 'framework7/modules/utils/utils';
import { ComponentFunction as Component } from 'framework7/modules/component/component';
import { StoreObject as Store, StoreParameters, createStore } from 'framework7/modules/store/store';
...
import { AreaChart } from 'framework7/components/area-chart/area-chart';
import { Autocomplete } from 'framework7/components/autocomplete/autocomplete';
import { Badge } from 'framework7/components/badge/badge';
import { Block } from 'framework7/components/block/block';
import { Breadcrumbs } from 'framework7/components/breadcrumbs/breadcrumbs';
import { Button } from 'framework7/components/button/button';
...
import { Link } from 'framework7/components/link/link';
...
import { PieChart } from 'framework7/components/pie-chart/pie-chart';
